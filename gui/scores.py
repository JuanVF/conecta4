...
class Score:
    ...
    def __loop(self):
        while self.__running:
            ...
            self.__screen.blit(self.__scroll_button.get_image(), (self.__scroll_button.x, self.__scroll_button.y))
    ...
    def __render_scores(self):
        ...
        for score in self.__scores:
            ...
            self.__pygame.draw.line(self.__screen, COLOR_WHITE, (0,y + self.__current_scroll +80), (1000, y + self.__current_scroll + 80), 2)

            y += 100

    def __scroll_scores(self):
        up_pressed = is_sprite_pressed(self.__pygame, self.__scroll_button, 70, 75)
        down_pressed = is_sprite_pressed(self.__pygame, self.__scroll_button, 70, 150)
